    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/90 backdrop-blur-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
        ...
        <Link href="/" className="group flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-foreground group-hover:text-accent-light transition-colors">
            메두사 개발 연구소
          </span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a
            ...
            className="flex items-center gap-1.5 text-sm font-medium text-muted hover:text-accent-light transition-colors"
            aria-label="GitHub"
          >
            <svg
              className="h-5 w-5"
        ...
        <div className="md:hidden border-t border-border bg-surface px-4 py-3">
          <nav className="flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm font-medium text-muted hover:text-accent-light transition-colors"
            >
              GitHub
            </a>
          </nav>
